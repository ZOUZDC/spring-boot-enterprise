...
public class TestController {
     ...
     */
    @RequestMapping("/s5")
    public ResultVo getStudent5(Student student, @Validated(Dto.Save.class) StudentGroupDto studentGroupDto) {
     ...
     */
    @RequestMapping("/s5_1")
    public ResultVo getStudent51(Student student, @Validated(Dto.Save.class) StudentGroupDto studentGroupDto, BindingResult ex) {
     ...
     */
    @RequestMapping("/s6")
    public ResultVo getStudent6(Student student, @Validated(Dto.Delete.class) StudentGroupDto studentGroupDto) {
